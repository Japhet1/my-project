                    ...
                    <div className="">
                        ...
                        <div className="my-4 px-4">
                            ...
                            <div className="mt-4 px-4">
                                <p className="md:text-lg lg:text-base font-semibold text-center leading-8">{project.description}</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-wrap my-4 md:my-10 lg:my-4 px-4 gap-2 justify-center md:text-sm lg:text-sm">
                        {project.stack.map((project, id) => <h1 key={id} className="py-1 px-2 bg-gray-100 dark:bg-blue-950  md:bg-white md:dark:bg-blue-950 lg:bg-white lg:dark:bg-blue-950 rounded-md">{project.item}</h1>)}
                    </div>
