    ...
    <main id="project" className="font-gruppo md:py-10 mt-10 border-b border-green-200 mx-6 md:mx-10 dark:border-green-900 scroll-mt-28 scroll-smooth">
        ...
        <div className="my-16 space-y-10 md:p-10 md:text-center">
            {projectData.map((project, index) => (
                <div key={index} className="flex p-10 mb-10 md:mb-16 lg:mb-0 dark:text-white rounded-md">
                    ...
                    <div className="grid grid-flow-col">
                        ...
                        <div className="col-span-6 items-center px-10 lg:h-72">
                            ...
                            <div className="flex flex-wrap my-4 md:my-10 lg:my-4 px-4 gap-2 justify-center items-center md:text-sm lg:text-sm">
                                ...
                                {project.stack.map((project, id) => <h1 key={id} className="py-1 px-2 bg-green-100 dark:bg-cyan-800  md:bg-green-100 md:dark:bg-green-800 lg:bg-green-100 lg:dark:bg-green-800 rounded-md font-normal">{project.item}</h1>)}
                            </div>
