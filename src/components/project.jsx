    ...
    <main id="project" className="font-gruppo md:py-10 mt-10 md:mx-10 scroll-mt-28 scroll-smooth drop-shadow-2xl">
        ...
        <div className="flex my-16 space-x-5 md:text-center">
            {projectData.map((project, index) => (
                <div key={index} className="mb-10 md:mb-16 lg:mb-0 dark:text-white p-2 bg-[#2A629A] dark:bg-slate-800 rounded-xl">
                   
                    <div className="grid ">
                        <div className="col-span-6">
                            <div className="md:max-w-lg lg:max-w-lg lg:w-full transition-all bg-inherit" style={{}}>
                                <img className=" lg:w-full lg:h-72 rounded-xl" src={`/${project.src}`} alt="first project" />
                            </div>
                        </div>
                        
                 
                        <div className="col-span-6 items-center py-5 lg:h-72">
