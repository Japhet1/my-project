...
const Contact = ({ contactData }) => {
  return (
    <main id="contact" className="font-gruppo p-10 md:mx-10 lg:mx-20 scroll-smooth">
        <div>
            <h1 className="text-blue-950 text-3xl md:text-4xl lg:text-5xl font-bold dark:text-blue-100">Contact</h1>
        </div>
        <div className="lg:flex md:flex md:flex-wrap justify-center items-center md:gap-4 lg:space-x-20 pt-16">
            {contactData.map((contact, index) => (
                <div key={index} className="flex items-center md:gap-2 lg:gap-2">
                    <div className="lg:w-20 md:text-2xl lg:text-4xl p-5 text-blue-950 dark:text-white">
                    ...
                    <span className="md:text-xl lg:text-2xl font-semibold dark:text-white">{contact.content}</span>
                </div>
            ))}        
        </div>
    </main>
