...
const Skill = () => {
  return (
    <main id="skill" className=" lg:text-center md:py-10 font-poppins md:p-10 mt-10 md:mx-10 scroll-mt-28 scroll-smooth">
        <div className="">
        ...
        <div className="flex flex-wrap justify-center items-center text-8xl gap-32 my-20 drop-shadow-2xl">
