...
const Education = ({ educationData }) => {
  return (
    <main className="lg:text-center md:py-10 font-rajdhani lg:p-10 mt-10 border-b border-orange-200 md:mx-10 dark:border-orange-900">
        <div>
            <h1 className="text-orange-500 md:text-4xl lg:text-5xl font-bold">Education and Training</h1>
        </div>
        <div className="my-16">
