...
function Header({ headerData }) {
  return (
    <main id="about" className="text-center font-rajdhani items-center py-10 md:py-10 lg:px-32 lg:py-16 border-b border-blue-200 md:mx-10 dark:border-blue-900 scroll-mt-28 scroll-smooth">
      ...
      <div className="md:mt-5 lg:mt-10">
        <h1 className="text-2xl md:text-4xl lg:text-4xl text-blue-500 font-bold my-2 md:my-2 lg:my-2">{headerData.welcome}</h1>
        ...
        <div className="px-8 md:px-20 lg:px-40 text-center">
          <p className="text-md md:text-lg lg:text-xl loading-8 dark:text-white">{headerData.summary}</p>
        </div>
        
        <div className="flex justify-center items-center mt-5 p-5 gap-10">
          <button><a className="flex justify-center items-bottom gap-4 md:px-10 md:py-2 p-2 text-md md:text-lg lg:text-xl bg-blue-500 hover:bg-blue-100 hover:shadow-lg text-white hover:text-blue-500 transition-all rounded-md" href="https://github.com/Japhet1" target="_blank" rel="noreferrer"><BsGithub className="text-xl md:text-2xl lg:text-2xl"/>Repository</a></button>
          <button><a className="flex justify-center items-bottom gap-4 md:px-10 md:py-2 p-2 text-md md:text-lg lg:text-xl bg-blue-500 hover:bg-blue-100 hover:shadow-lg text-white hover:text-blue-500 transition-all rounded-md" href="https://github.com/Japhet1" target="_blank" rel="noreferrer">Resume<BsDownload className="text-xl md:text-2xl lg:text-2xl"/></a></button>
        </div>
      </div>
    </main>
  )
